...
print_access_info() {
    ...
    echo ""
    echo "=== For Remote Server Access (from local machine) ==="
    echo ""
    echo "1. Create SSH tunnels on your LOCAL machine:"
    echo "   ssh -L 3000:localhost:3000 user@$(hostname -I | awk '{print $1}')"
    echo "   ssh -L 9090:localhost:9090 user@$(hostname -I | awk '{print $1}')"
    echo ""
